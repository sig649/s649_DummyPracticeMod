...
namespace s649_DummyPracticeMod.Codes
{
    public class BepInConfig
    {
        ...
        public static int sleeinessExchangeRate = (int)Mathf.Clamp(MainPlugin.CE_SleepinessExchangeRate.Value, 1, 100);
        ...
        public static int hungerExchangeRate = (int)Mathf.Clamp(MainPlugin.CE_HungerExchangeRate.Value, 1, 100);
