...
namespace s649_DummyPracticeMod.Codes
{
    public class BepInConfig
    {
        ...
        public static int sleeinessExchangeUpperLimit = (int)Mathf.Clamp(MainPlugin.CE_SleepinessExchangeUpperLimit.Value, 1, 99);
        public static int sleeinessExchangeLowerLimit = (int)Mathf.Clamp(MainPlugin.CE_SleepinessExchangeLowerLimit.Value, 1, 99);

        //public static int hungerExchangeBaseRate = (int)Mathf.Clamp(MainPlugin.CE_HungerExchangeBaseRate.Value, 0, 100);
        public static int hungerExchangeUpperLimit = (int)Mathf.Clamp(MainPlugin.CE_HungerExchangeUpperLimit.Value, 1, 99);
        public static int hungerExchangeLowerLimit = (int)Mathf.Clamp(MainPlugin.CE_HungerExchangeLowerLimit.Value, 1, 99);
